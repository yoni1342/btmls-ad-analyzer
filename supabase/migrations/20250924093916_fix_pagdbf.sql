-- Create unified paginated function for data tables (excluding overview)
-- This function handles all data table types with pagination while maintaining interdependent relationships
...
BEGIN
    ...
    ELSIF primary_table_param = 'adsets' THEN
        -- Paginated ad sets with related data
    ...
    ELSIF primary_table_param = 'ads' THEN
        -- Paginated ads with related data
    ...
    ELSIF primary_table_param = 'comments' THEN
        -- Paginated comments with related data
