-- Fix funnel distribution to include ads without funnel data as 'Unprocessed'
-- This ensures the chart always shows all ads, even those without funnel categorization
