-- Add campaign and adset filters to get_dashboard_data function
-- This adds campaign_status_param, campaign_objective_param, adset_status_param, and adset_optimization_param
-- to enable filtering campaigns and adsets, which will cascade filter all subsequent tables
