        ...
        'untracked_info', (
            SELECT json_build_object(
                'untracked_ads_count', (
                    ...
                    WHERE brand_id = brand_id_param AND (("Angel" IS NULL OR lower(trim("Angel")) = '' OR lower(trim("Angel")) = 'unknown') AND (angle_type IS NULL OR lower(trim(angle_type)) = 'unknown'))
                ),
