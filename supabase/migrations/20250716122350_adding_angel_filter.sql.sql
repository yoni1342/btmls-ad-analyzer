...
BEGIN
    ...
    WITH filtered_comments AS (
        ...
        WHERE
            ...
            AND (angel_param IS NULL OR angel_param = 'all' OR lower(trim(a."Angel")) = lower(angel_param))
    )
            ...
            SELECT json_build_object(
                'untracked_ads_count', (
                    ...
                    WHERE brand_id = brand_id_param
                      ...
                      AND (angel_param IS NULL OR angel_param = 'all' OR lower(trim("Angel")) = lower(angel_param))
                      AND (
                        "Angel" IS NULL
                        OR lower(trim("Angel")) = ''
