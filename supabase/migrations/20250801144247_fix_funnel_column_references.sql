-- Fix funnel column references in dashboard function
-- The previous migration used funnel_stage but it should be funnel
...
IS 'Fixed dashboard function with correct funnel column references and hierarchical campaign -> ad set -> ads relationships for filtering support';
