-- Fix GROUP BY issue in get_dashboard_data function
-- The json_agg with ORDER BY needs proper structure
...
IS 'Fixed GROUP BY issue with json_agg and ORDER BY clauses in dashboard function';
