-- Create RPC function to get ad sets data for a brand
...
BEGIN
    ...
    INNER JOIN public.brands b ON aa.brand_id = b.id
...
IS 'Fetches essential ad set data for a specific brand with optional date filtering. Includes key columns for budget analysis, optimization insights, and performance tracking.';