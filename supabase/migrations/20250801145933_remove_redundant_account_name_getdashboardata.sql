-- Remove redundant account_name from dashboard function
-- Since data is already filtered by brand, account name is not needed
...
-- Add comment for the cleanup
COMMENT ON FUNCTION get_dashboard_data(integer, text, text, text, text, text) 
IS 'Cleaned up dashboard function removing redundant account_name since data is already filtered by brand';
