-- Extend get_brands_tables_paginated function to support selection-based interdependent filtering
-- This enables bidirectional table filtering based on checkbox selections
