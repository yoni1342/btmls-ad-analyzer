...
BEGIN
    WITH filtered_comments AS (
        ...
        WHERE
            ...
            AND (start_date_param IS NULL OR c.created_time >= start_date_param::timestamp)
            AND (end_date_param IS NULL OR c.created_time <= end_date_param::timestamp)
