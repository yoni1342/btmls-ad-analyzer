-- Fix two issues:
-- 1. Add funnel distribution data for dashboard graphs
-- 2. Fix lifetime filter to respect return_full_data parameter for brands page
